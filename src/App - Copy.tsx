...
function App() {
  ...
  useEffect(() => {
    ...
    // setTimeout(() => {
    //   console.log("ram 3", remainingCards.length)
    // }, 1)
  }, [])
  ...
  function getHand(hand: Hand, coloda: Card[], conditions: HandConditions) {
    console.log("rem 3", coloda.length)
    let colodaMini: Card[] = []
    do {
      hand.hand = [];
      colodaMini = [...coloda]
      for (let i = 0; i < 13; i++) {
        let index = generateRandomIndex(colodaMini);
        let element = colodaMini[index];
        hand.hand.push(element);
        colodaMini = colodaMini.filter((cardInRemainingCards) => cardInRemainingCards !== element);
      }
    } while (isValid(hand, conditions));

    debugger
    return { hand: hand, remainingCards: colodaMini }
  }
  ...
  const customList = (param: "left" | "right" | "hand2") => {
    ...
    let label: string = ""
    if (param === "left") {
      label = "Coloda (" + leftMini.length + ")"
      colodaToShow = leftMini
    }
    if (param === "right") {
  ...
  const handleCheckedRight = () => {
    ...
    setTimeout(() => {
      console.log("rem", remainingCards.length)
    }, 100)
  };
  ...
  function getValueForHand(hand: Hand, type: string) {
    return `${type}`
  }
  function genHand(hand: Hand) {
    ...
    // setRemainingCards(foo.remainingCards)
    // setLeft(remainingCards)
  }

  function setValueForHand(hand: Hand, type: string) {
    return undefined
    // (e) => {
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '5px', width: '180px' }}>
            ...
            <input
              ...
              name="minPoints"
              style={{ width: '50px' }}
              value={getValueForHand(hand1, "minPoints")}
              onChange={setValueForHand(hand1, "minPoints")}
            />
          </div>
          <div>
            ...
            <input
              ...
              name="maxPoints"
              style={{ width: '50px' }}
              value={getValueForHand(hand1, "maxPoints")}
              onChange={setValueForHand(hand1, "maxPoints")}
            />
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <div style={{ width: '180px' }}>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberSpadesMin")}
            onChange={setValueForHand(hand1, "numberSpadesMin")}
          />
        </div>
        <div>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberSpadesMax")}
            onChange={setValueForHand(hand1, "numberSpadesMax")}
          />
        </div>
      </div>
      <div style={{ display: 'flex', gap: '10px' }}>
        <div style={{ width: '180px' }}>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberHeartsMin")}
            onChange={setValueForHand(hand1, "numberHeartsMin")}
          />
        </div>
        <div>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberHeartsMax")}
            onChange={setValueForHand(hand1, "numberHeartsMax")}
          />
        </div>
      </div>
      <div style={{ display: 'flex', gap: '10px' }}>
        <div style={{ width: '180px' }}>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberDiamondsMin")}
            onChange={setValueForHand(hand1, "numberDiamondsMin")}
          />
        </div>
        <div>
          ...
          <input
            ...
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberDiamondsMax")}
            onChange={setValueForHand(hand1, "numberDiamondsMax")}
          />
        </div>
      </div>
      <div style={{ display: 'flex', gap: '10px' }}>
        <div style={{ width: '180px' }}>
          ...
          <input
            ...
            name="numberClubsMin"
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberClubsMin")}
            onChange={setValueForHand(hand1, "numberClubsMin")}
          />
        </div>
        <div>
          ...
          <input
            ...
            name="numberClubsMax"
            style={{ width: '50px' }}
            value={getValueForHand(hand1, "numberClubsMax")}
            onChange={setValueForHand(hand1, "numberClubsMax")}
          />
        </div>
      </div>
    </div >
